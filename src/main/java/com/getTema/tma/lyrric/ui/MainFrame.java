...
import com.getTema.tma.lyrric.util.ParseUtil;
...
public class MainFrame extends JFrame {
     ...
     * 疫苗列表
     */
    private List<TestVoList> vaccines;
    ...
    private void init(){
        ...
        tkLabel.setBounds(50, 20, 60, 25);
        this.add(tkLabel);
          tk = new JTextField();
        tk.setBounds(70, 20, 20, 20);
        this.add(tk);
...
//            }设置cookie成功
        ...
        String[] columnNames = { "年龄", "生肖","数量","价格" };
        ...
        if(vaccines != null && !vaccines.isEmpty()){
            for (TestVoList t : vaccines) {
                System.out.println(t);
                String[] item = { t.getAge().toString(), t.getSx(),t.getNum().toString() ,t.getPrice().toString()};
